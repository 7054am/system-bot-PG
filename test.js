...
if (message.content === '&inv') {
      message.author.send('https://discordapp.com/api/oauth2/authorize?client_id=585132250786693176&permissions=0&scope=bot').catch(e => console.log(e.stack));
...
client.login('NTg1MTMyMjUwNzg2NjkzMTc2.XPVA5A.ml1DASp8vmZhiKO7jsu4V0OdWn8');
